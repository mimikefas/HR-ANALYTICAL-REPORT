This project analyses human resource data to understand workforce growth, salary trends, employee performance distribution, and workforce demographics from 2018 to 2020. The goal is to provide HR stakeholders with data driven insights that support workforce planning, compensation analysis, and performance management. The data consist of 1000 rows and 12 columns.
...
## Employee Performance Analysis
	...
	•	Performance improved slightly in 2020 by approximately 2% compared with the previous year.
...
## Key Takeaways
 ...
 ## Recommendations
	1.	Review compensation policies to maintain competitive salary structures during workforce expansion.
	2.	Implement targeted performance development programs to improve overall employee productivity.
	3.	Develop long term workforce planning strategies to support leadership development and succession planning.
